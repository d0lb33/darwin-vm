...
| Screen-sized shared-RAM render target | Exact guest: 3 displayed CARenderer frames pass | See `gpu-shared-quartzcore-ios27.md`; persistent cross-process pool handoff and sustained pacing remain unproven |
