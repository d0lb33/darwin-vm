...
for name in driver_contract_test driver_capability_test test_render_writeback test_owned_surface_frontend test_framebuffer_read test_private_block_texture; do
