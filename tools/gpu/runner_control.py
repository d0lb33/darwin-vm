...
def main():
    ...
    result=dict(job=job,bundle=str(bundle),sha256=digest,signature=signature,expected=a.expected,test=a.test,frames=a.frames,mode=a.mode,development=a.development,
