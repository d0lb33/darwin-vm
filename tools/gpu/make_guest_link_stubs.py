...
system = {
 '___error','___memcpy_chk','___sprintf_chk','___stack_chk_fail','___stack_chk_guard','___stderrp',
 '_CC_SHA256','_close','_dlerror','_dlopen','_dlsym','_dup2','_execl','_exit','__exit','_fork','_fprintf','_getenv',
 '_memcmp','_memcpy','_memset','_pipe','_read','_setenv','_strcmp','_waitpid','_write','__Unwind_Resume','_dispatch_data_create',
